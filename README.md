...
**Primary practice:** Navigation states and layout constraints

## What I built

Wanderly uses a navigation list, active and inactive classes, a constrained layout, hover styling, and transform behavior to practice navigation-state presentation.
